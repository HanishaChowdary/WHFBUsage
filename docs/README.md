...
Now, we can use this Registration details from the Custom Log, Compare with our WHFB Usage from Sign in Logs and generate the Analysis. I will share the JSON code for this specific part which can be built on top of [Michael's workbook](https://techcommunity.microsoft.com/t5/core-infrastructure-and-security/azure-ad-sign-in-logs-workbooks-know-who-is-using-windows-hello/ba-p/2661980)
